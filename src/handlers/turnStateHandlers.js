...
module.exports = Alexa.CreateStateHandler(Consts.GAME_STATES.TURN, {
    'PlayerMoveTaxi': function () {
      ...
      GameFlow.doPlayerMove(this, position, Game.CONSTS.TRANSPORTATION.TAXI);
    },
    'PlayerMoveBus': function () {
      const position = parseInt(this.event.request.intent.slots.position.value);
      GameFlow.doPlayerMove(this, position, Game.CONSTS.TRANSPORTATION.BUS);
    },
    'PlayerMoveTrain': function () {
      const position = parseInt(this.event.request.intent.slots.position.value);
      GameFlow.doPlayerMove(this, position, Game.CONSTS.TRANSPORTATION.TRAIN);
    },
    'PlayerMoveAny': function () {
      const position = parseInt(this.event.request.intent.slots.position.value);
      GameFlow.doPlayerMove(this, position);
    },
